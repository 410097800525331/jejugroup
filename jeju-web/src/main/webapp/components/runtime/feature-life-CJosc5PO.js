...
import { c as q, g as F, d as B, s as Y, S as K, e as Q, f as X, D as J } from "./feature-hotel-DpOGYw66.js";
const z = [
  ...
  }, [a.guest.adults, a.guest.children, a.guest.rooms]), p = s.useMemo(() => H.filter((l) => a.requiredOptions.includes(l.value)).map((l) => l.label), [a.requiredOptions]), R = s.useMemo(() => p.length === 0 ? "선택사항 없음" : p.length > 2 ? `${p[0]}, ${p[1]} 외 ${p.length - 2}` : p.join(", "), [p]), G = s.useMemo(() => {
...
}, ue = () => /* @__PURE__ */ t.jsx(te, { children: /* @__PURE__ */ t.jsx(de, {}) }), me = () => /* @__PURE__ */ t.jsx(ue, {});
export {
  me as L
};
