import { j as e, a as u } from "./react-vendor-BoSfm_Te.js";
import { U as v, a as N, S as x, b as E, c as b, P as f, d as p, e as S, M as I, f as R, g as w, L as C, h as A, H as k, i as T, j as L, k as y, G as M, C as V, l as H, m as _, n as O, o as P, p as U, q as $, B as g, r as D, s as G, t as q } from "./icon-vendor-Dpra3II6.js";
import { a as B } from "./legacy-core-0fkWHL1L.js";
const Y = {
  "book-open": D,
  "building-2": g,
  calendar: $,
  ...
  user: N,
  users: v
}, n = ({ name: s, className: a }) => {
  const l = Y[s] ?? G;
  return /* @__PURE__ */ e.jsx(l, { className: a, strokeWidth: 1.9, "aria-hidden": "true", focusable: "false" });
}, F = ({ item: s }) => /* @__PURE__ */ e.jsxs("li", { className: "hotel-shell-nav-item", children: [
  /* @__PURE__ */ e.jsxs("a", { href: "#", className: "hotel-shell-nav-link route-link", "data-route": s.route, children: [
    /* @__PURE__ */ e.jsxs("span", { className: "hotel-shell-nav-icon-roll stagger-wrapper", "aria-hidden": "true", children: [
      /* @__PURE__ */ e.jsx("span", { className: "hotel-shell-nav-icon-layer stagger-original", children: /* @__PURE__ */ e.jsx(n, { name: s.icon, className: "hotel-shell-nav-icon" }) }),
      /* @__PURE__ */ e.jsx("span", { className: "hotel-shell-nav-icon-layer stagger-clone", children: /* @__PURE__ */ e.jsx(n, { name: s.icon, className: "hotel-shell-nav-icon" }) })
    ] }),
  ...
  /* @__PURE__ */ e.jsxs("div", { className: "hotel-shell-mega-dropdown", children: [
    /* @__PURE__ */ e.jsx("div", { className: "hotel-shell-mega-menu-list-container", children: s.menuItems.map((a) => /* @__PURE__ */ e.jsxs(
      "a",
      {
        ...
        children: [
          /* @__PURE__ */ e.jsx(n, { name: a.icon, className: "hotel-shell-mega-menu-icon" }),
...
], se = ({ basePath: s }) => /* @__PURE__ */ e.jsxs("header", { className: "header hotel-shell-header", id: "header", children: [
  /* @__PURE__ */ e.jsxs("div", { className: "hotel-shell-header-container", children: [
    ...
    /* @__PURE__ */ e.jsx("nav", { className: "hotel-shell-main-nav", children: /* @__PURE__ */ e.jsx("ul", { className: "hotel-shell-nav-list", children: W.map((a) => /* @__PURE__ */ e.jsx(F, { item: a }, `${a.route}-${a.dataLang}`)) }) }),
    /* @__PURE__ */ e.jsxs("div", { className: "hotel-shell-header-utils", children: [
      /* @__PURE__ */ e.jsxs(
        "a",
        {
          ...
          style: { display: "none" },
          children: [
            /* @__PURE__ */ e.jsx(n, { name: "shield-check", className: "hotel-shell-util-icon" }),
            /* @__PURE__ */ e.jsx("span", { children: "관리자 페이지" })
          ]
        }
      ),
      /* @__PURE__ */ e.jsxs("a", { href: "#", className: "hotel-shell-util-link route-link", "data-action": "OPEN_RESERVATION_DRAWER", children: [
        /* @__PURE__ */ e.jsx(n, { name: "clipboard-list", className: "hotel-shell-util-icon" }),
        /* @__PURE__ */ e.jsx("span", { "data-lang": "navResCheck", children: "예약 확인" })
      ] }),
      /* @__PURE__ */ e.jsxs(
        "a",
        {
          ...
          id: "headerLoginBtn",
          children: [
            /* @__PURE__ */ e.jsx(n, { name: "user", className: "hotel-shell-util-icon" }),
      ...
      /* @__PURE__ */ e.jsxs("a", { href: "#", className: "hotel-shell-util-link route-link", "data-route": "CS.CUSTOMER_CENTER", children: [
        /* @__PURE__ */ e.jsx(n, { name: "headphones", className: "hotel-shell-util-icon" }),
        /* @__PURE__ */ e.jsx("span", { "data-lang": "navCs", children: "고객센터" })
      ] })
    ] }),
    /* @__PURE__ */ e.jsx("button", { className: "hotel-shell-mobile-menu-btn", id: "mobileMenuBtn", "aria-label": "메뉴 열기", children: /* @__PURE__ */ e.jsx(n, { name: "menu", className: "hotel-shell-util-icon" }) })
  ] }),
  /* @__PURE__ */ e.jsx("div", { className: "hotel-shell-mobile-nav", id: "mobileNav", children: /* @__PURE__ */ e.jsx("ul", { className: "hotel-shell-mobile-nav-list", children: J.map((a) => /* @__PURE__ */ e.jsx("li", { children: /* @__PURE__ */ e.jsx(
    "a",
    {
      href: "#",
...
] }), z = (s) => s * Math.PI / 180, K = (s, a, l, t, r) => {
  const h = a > 1 ? (r - t) / (a - 1) : 0, d = t + h * s, o = z(d), c = Math.cos(o) * l, i = Math.sin(o) * l;
  return {
    "--tx": `${c.toFixed(2)}px`,
    "--ty": `${i.toFixed(2)}px`,
...
function Q({
  ...
  const [d, o] = u.useState(!1), c = u.useRef(null);
  return u.useEffect(() => {
    const i = (m) => {
  ...
  }, []), /* @__PURE__ */ e.jsxs("div", { className: "family-radial-shell", children: [
    /* @__PURE__ */ e.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ e.jsx("div", { className: "family-radial-items", children: s.map((i, m) => {
            const j = i.icon;
            return /* @__PURE__ */ e.jsx(
              "a",
              {
                ...
                href: i.href,
                rel: i.rel,
                style: K(m, s.length, t, r, h),
                target: i.target,
                title: i.title,
                children: /* @__PURE__ */ e.jsx(j, { size: 18, strokeWidth: 2.2 })
              },
              i.key
            );
          }) })
...
const X = [
...
], le = () => /* @__PURE__ */ e.jsxs("footer", { className: "footer section shell-footer", id: "section-footer", children: [
  /* @__PURE__ */ e.jsxs("div", { className: "footer-content", children: [
    ...
    /* @__PURE__ */ e.jsxs("div", { className: "footer-right-group", children: [
      /* @__PURE__ */ e.jsx(Q, { items: X, radiusPx: 72 }),
  ...
  return /* @__PURE__ */ e.jsxs("header", { className: "header main-header", id: "header", children: [
    /* @__PURE__ */ e.jsxs("div", { className: "header-util", id: "index-header-util", children: [
      ...
      /* @__PURE__ */ e.jsx("span", { className: "util-divider", children: "|" }),
      /* @__PURE__ */ e.jsx("a", { href: "#", className: "util-link route-link", "data-action": "OPEN_RESERVATION_DRAWER", "data-lang": "reservationCheck", children: "예약 확인" }),
      /* @__PURE__ */ e.jsx("span", { className: "util-divider", children: "|" }),
      /* @__PURE__ */ e.jsx(
        "a",
        {
