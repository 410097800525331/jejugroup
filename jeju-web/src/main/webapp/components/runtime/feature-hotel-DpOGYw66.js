...
import { b as E } from "./feature-layout-Czr3ndvg.js";
import { a as Fe } from "./legacy-core-0fkWHL1L.js";
import { W as _e } from "./feature-ui-DQIlUdQs.js";
const He = {
  ...
  const a = new Date(e);
  return a.setMonth(a.getMonth() + t, 1), H(a);
}, Be = (e = {}) => {
  const t = e.checkIn ?? e.tempCheckIn ?? e.visibleMonth ?? Date.now(), a = H(e.visibleMonth ?? t);
  return {
    ...{
      isOpen: !1,
      activeTab: "calendar",
...
}, Ge = (e = "sunday") => He[e], Ve = ({ tempCheckIn: e, tempCheckOut: t }, a) => {
  const n = B(a);
  return !e || t ? {
    tempCheckIn: n,
    tempCheckOut: null,
...
}, We = (e, t) => t === "monday" ? e === 0 ? 6 : e - 1 : e, qe = (e, t) => typeof t == "function" ? t(e) : `${e.getFullYear()}-${String(e.getMonth() + 1).padStart(2, "0")}`, ze = (e) => `${e.getFullYear()}년 ${e.getMonth() + 1}월 ${e.getDate()}일`, Ye = ({
  visibleMonth: e,
  checkIn: t,
  checkOut: a,
  hoverDate: n,
  ...
  const d = B(m), b = t && !a && n && n > t ? n : null, x = Array.isArray(r) && r.length === 7 ? r : Ge(l);
  return Array.from({ length: s }, (p, w) => {
    const h = new Date(e);
    h.setMonth(h.getMonth() + w, 1);
    const y = h.getFullYear(), v = h.getMonth(), L = new Date(y, v, 1).getDay(), S = We(L, l), f = new Date(y, v + 1, 0).getDate(), N = [];
    for (let I = 0; I < S; I += 1)
      N.push({
        key: `${y}-${v + 1}-outside-${I}`,
        label: "",
    ...
    for (let I = 1; I <= f; I += 1) {
      const P = new Date(y, v, I), k = B(P), T = t === k, C = a === k, g = b === k, A = T && !!(a || b) || C && !!t;
      N.push({
        key: `${y}-${v + 1}-${I}`,
        label: String(I),
        ariaLabel: ze(P),
        ...
        isCheckIn: T,
        isCheckOut: C,
        isInRange: !!(t && a && k > t && k < a),
        isHoverRange: !!(b && t && k > t && k < b),
        isHoverEnd: g,
        hasRange: A
      });
    }
...
], Y = (e) => e.trim().toLowerCase().replace(/\s+/g, ""), Ke = (e) => {
  const t = Y(e);
  return t ? fe.find(
    (a) => a.aliases.some((n) => Y(n) === t)
  ) ?? null : null;
}, Je = (e) => {
  if (!e)
    return null;
  const t = Y(e);
  return fe.find((a) => a.region === t) ?? null;
}, K = (e) => {
  if (!e)
    return null;
  ...
  const t = new URLSearchParams(e), a = t.get("keyword"), n = t.get("region"), s = Je(n);
  return {
    destinationValue: (a == null ? void 0 : a.trim()) || (s == null ? void 0 : s.label) || "",
    guest: {
      adults: q(t.get("adults"), 1, 1),
      children: q(t.get("children"), 0, 0),
      rooms: q(t.get("rooms"), 1, 1)
    },
    calendar: {
      checkIn: K(t.get("checkIn")),
      checkOut: K(t.get("checkOut"))
    }
  };
}, Ze = (e, t = "") => {
  const a = {}, n = new URLSearchParams(t), s = Xe(t), l = e.destinationValue.trim(), r = l ? Ke(l) : null, c = J(e.calendar.checkIn), m = J(e.calendar.checkOut);
...
}, xe = o.createContext(null), Qe = (e) => {
  var s, l, r, c, m;
  const t = Be(), a = ((s = e == null ? void 0 : e.calendar) == null ? void 0 : s.checkIn) ?? null, n = ((l = e == null ? void 0 : e.calendar) == null ? void 0 : l.checkOut) ?? null;
  return {
    activeTab: "hotel",
    ...
    calendar: {
      ...
      tempCheckIn: a,
      tempCheckOut: n,
      visibleMonth: a ? H(a) : t.visibleMonth
    }
  };
}, X = (e, t) => {
  if (!e)
    ...
    case "SHIFT_CALENDAR_MONTH":
      return {
        ...
        calendar: {
          ...e.calendar,
          hoverDate: null,
          visibleMonth: Ue(e.calendar.visibleMonth, t.delta)
        }
      };
    ...
    case "CONFIRM_CALENDAR": {
      ...
      return {
        ...
        calendar: {
          ...
          tempCheckIn: a,
          tempCheckOut: n,
          visibleMonth: a ? H(a) : e.calendar.visibleMonth
        }
      };
    }
    case "CLEAR_CALENDAR":
...
}, ke = ({ children: e, initialState: t }) => {
  const [a, n] = o.useReducer(et, t, Qe);
  o.useEffect(() => {
    const u = () => {
      R(n);
    };
  ...
  const s = o.useCallback((u) => {
  ...
  }, []), x = o.useCallback((u, W, D) => {
    D.stopPropagation(), n({ type: "ADJUST_GUEST", key: u, delta: W });
  }, []), p = o.useCallback(
    (u) => {
    ...
    a.destinationValue,
    a.guest
  ]), k = a.activeTab !== "activity", T = o.useMemo(() => {
  ...
  return /* @__PURE__ */ i.jsx(xe.Provider, { value: A, children: e });
}, F = () => {
  ...
  return /* @__PURE__ */ i.jsx("div", { className: `search-form-new${e.activeTab === "activity" ? "" : " hidden"}`, id: "searchFormActivity", children: /* @__PURE__ */ i.jsx("div", { className: "global-search-container", children: /* @__PURE__ */ i.jsxs("div", { className: "global-search-bar", children: [
    /* @__PURE__ */ i.jsxs("div", { className: "search-item destination-item-new", id: "destinationFieldActivity", children: [
      /* @__PURE__ */ i.jsx("div", { className: "item-icon", children: /* @__PURE__ */ i.jsx(E, { className: "search-field-icon", name: "search" }) }),
    ...
    /* @__PURE__ */ i.jsx("div", { className: "search-btn-wrapper", children: /* @__PURE__ */ i.jsxs("button", { className: "search-btn-pill", id: "searchBtnActivity", children: [
      /* @__PURE__ */ i.jsx(E, { className: "search-btn-icon", name: "search" }),
  ...
  const u = x.activeTab === "calendar", W = o.useMemo(() => Ye({
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ i.jsxs("div", { className: "Popup__content Popup__content_Occupancy", children: [
        ...
        /* @__PURE__ */ i.jsxs("div", { className: "RangePicker-Header", children: [
          /* @__PURE__ */ i.jsx("div", { className: "RangePicker-NavPrev", children: /* @__PURE__ */ i.jsx(
            "button",
            {
              ...
              onClick: y,
              type: "button",
              children: /* @__PURE__ */ i.jsx(E, { className: "calendar-nav-icon", name: "chevron-left" })
            }
          ) }),
          ...
          /* @__PURE__ */ i.jsx("div", { className: "RangePicker-NavNext", children: /* @__PURE__ */ i.jsx(
            "button",
            {
              ...
              onClick: v,
              type: "button",
              children: /* @__PURE__ */ i.jsx(E, { className: "calendar-nav-icon", name: "chevron-right" })
            }
          ) })
        ] }),
        /* @__PURE__ */ i.jsxs("div", { className: `RangePicker-Panel${u ? " active" : ""}`, id: a, role: "tabpanel", children: [
          /* @__PURE__ */ i.jsx("div", { className: "DayPicker", id: "dayPickerContainer", onMouseLeave: I, children: /* @__PURE__ */ i.jsx("div", { className: "DayPicker-wrapper", children: /* @__PURE__ */ i.jsx("div", { className: "DayPicker-Months", id: t, children: W.map((D) => /* @__PURE__ */ i.jsxs("div", { className: "DayPicker-Month", children: [
            /* @__PURE__ */ i.jsx("div", { className: "DayPicker-Caption", children: D.label }),
            /* @__PURE__ */ i.jsx("div", { className: "DayPicker-Weekdays", children: D.weekdays.map((j) => /* @__PURE__ */ i.jsx("div", { className: "DayPicker-Weekday", children: j }, `${D.key}-${j}`)) }),
            /* @__PURE__ */ i.jsx("div", { className: "DayPicker-Body", children: D.days.map((j) => {
              const O = ["DayPicker-Day"];
              return j.isOutside && O.push("DayPicker-Day--outside"), j.isDisabled && O.push("DayPicker-Day--disabled"), j.isToday && O.push("DayPicker-Day--today"), j.isSelected && O.push("DayPicker-Day--selected"), j.isCheckIn && O.push("DayPicker-Day--checkIn"), j.isCheckOut && O.push("DayPicker-Day--checkOut"), j.isInRange && O.push("DayPicker-Day--inRange"), j.isHoverRange && O.push("DayPicker-Day--hoverRange"), j.isHoverEnd && O.push("DayPicker-Day--hoverEnd"), j.hasRange && O.push("DayPicker-Day--hasRange"), j.isOutside || j.timestamp === null ? /* @__PURE__ */ i.jsx("div", { "aria-hidden": "true", className: O.join(" ") }, j.key) : /* @__PURE__ */ i.jsx(
                "button",
                {
                  "aria-label": j.ariaLabel,
                  className: O.join(" "),
                  "data-day": j.day ?? void 0,
          ...
          /* @__PURE__ */ i.jsxs("div", { className: "RangePicker-Footer", children: [
            ...
            /* @__PURE__ */ i.jsxs("div", { className: "RangePicker-FooterActions", children: [
              /* @__PURE__ */ i.jsx("button", { className: "ActionBtn ActionBtn--clear", id: r, onClick: w, type: "button", children: /* @__PURE__ */ i.jsx("span", { "data-lang": "btnReset", children: "선택 해제" }) }),
        ...
        /* @__PURE__ */ i.jsx("div", { className: `RangePicker-Panel${u ? "" : " active"}`, id: n, role: "tabpanel", children: /* @__PURE__ */ i.jsxs("div", { className: "Flexible-Content", children: [
          ...
          /* @__PURE__ */ i.jsx("div", { className: "Flexible-Options", children: b.map((D) => /* @__PURE__ */ i.jsx(
            "button",
            {
              className: `Flexible-Option${x.flexibleValue === D.value ? " active" : ""}`,
...
], lt = ["일", "월", "화", "수", "목", "금", "토"], ot = (e) => `${e.getFullYear()}년 ${e.getMonth() + 1}월`, ve = () => {
  const {
    state: e,
    stopPropagation: t,
    showPreviousMonth: a,
  ...
  const { state: e, selectDestination: t, stopPropagation: a } = F();
  return /* @__PURE__ */ i.jsx(
    ct,
    {
      columns: nt,
...
}, dt = ({ popupId: e, isOpen: t, rows: a, values: n, onAdjust: s, onInteract: l }) => /* @__PURE__ */ i.jsx("div", { className: `guest-popup-new${t ? " active" : ""}`, id: e, onClick: l, children: a.map((r) => /* @__PURE__ */ i.jsxs("div", { className: "guest-row-new", children: [
  ...
  /* @__PURE__ */ i.jsxs("div", { className: "guest-counter-new", children: [
    /* @__PURE__ */ i.jsx(
      "button",
      {
        ...
        type: "button",
        children: /* @__PURE__ */ i.jsx(E, { className: "counter-icon", name: "minus" })
      }
    ),
    ...
    /* @__PURE__ */ i.jsx(
      "button",
      {
        ...
        type: "button",
        children: /* @__PURE__ */ i.jsx(E, { className: "counter-icon", name: "plus" })
      }
    )
  ] })
] }, r.key)) }), Ie = () => {
  const { state: e, adjustGuest: t, stopPropagation: a } = F();
  return /* @__PURE__ */ i.jsx(
    dt,
    {
  ...
  return /* @__PURE__ */ i.jsx("div", { className: `search-form-new${e.activeTab === "activity" ? " hidden" : ""}`, id: "searchFormHotel", children: /* @__PURE__ */ i.jsx("div", { className: "global-search-container", children: /* @__PURE__ */ i.jsxs("div", { className: "global-search-bar", children: [
    ...
    /* @__PURE__ */ i.jsxs("div", { className: "search-item date-item-new", id: "checkInField", onClick: m, children: [
      /* @__PURE__ */ i.jsx("div", { className: "item-icon", children: /* @__PURE__ */ i.jsx(E, { className: "search-field-icon", name: "calendar" }) }),
      /* @__PURE__ */ i.jsxs("div", { className: "item-content", children: [
    ...
    /* @__PURE__ */ i.jsxs("div", { className: "search-item guest-item-new", id: "guestFieldLarge", onClick: c, children: [
      /* @__PURE__ */ i.jsx("div", { className: "item-icon", children: /* @__PURE__ */ i.jsx(E, { className: "search-field-icon", name: "users" }) }),
      /* @__PURE__ */ i.jsxs("div", { className: "item-content", children: [
...
}, mt = ({ activeTab: e, items: t, onTabChange: a, onInteract: n }) => /* @__PURE__ */ i.jsx("div", { className: "search-tabs-large", onClick: n, children: t.map((s) => /* @__PURE__ */ i.jsxs(
  "button",
  {
    ...
    type: "button",
    children: [
      /* @__PURE__ */ i.jsx(E, { className: "search-tab-icon", name: s.icon }),
      /* @__PURE__ */ i.jsx("span", { "data-lang": s.dataLang, children: s.label })
    ]
  },
  s.tab
)) }), pt = () => {
  const { state: e, setActiveTab: t, stopPropagation: a } = F();
  return /* @__PURE__ */ i.jsx(
    mt,
    {
...
}, ht = () => /* @__PURE__ */ i.jsx(ke, { children: /* @__PURE__ */ i.jsxs("div", { className: "search-widget-large", children: [
  /* @__PURE__ */ i.jsx(pt, {}),
  /* @__PURE__ */ i.jsx(ut, {}),
  /* @__PURE__ */ i.jsx(tt, {})
] }) }), gt = "jeju:hotel-search-widget-mounted", Zt = () => (o.useEffect(() => {
  const e = window.lucide;
  e != null && e.createIcons && e.createIcons(), document.dispatchEvent(new Event(gt));
}, []), /* @__PURE__ */ i.jsx(ht, {})), bt = () => {
  const {
    state: e,
    checkInLabel: t,
    checkOutLabel: a,
  ...
  const e = o.useMemo(() => {
    if (!(typeof window > "u"))
      return ye(window.location.search);
  }, []);
  return /* @__PURE__ */ i.jsx(ke, { initialState: e, children: /* @__PURE__ */ i.jsx("div", { className: "search-widget-large hotel-list-search-widget", children: /* @__PURE__ */ i.jsx(bt, {}) }) });
}, Qt = () => /* @__PURE__ */ i.jsx(ft, {}), je = ({ checkedOptionIds: e, onToggle: t, section: a }) => /* @__PURE__ */ i.jsxs("div", { className: "filter-section", children: [
...
] }), Z = 1e3, Q = (e) => e.toLocaleString("ko-KR"), ee = (e) => {
          ...
          /* @__PURE__ */ i.jsxs("label", { className: "price-box", children: [
            ...
            /* @__PURE__ */ i.jsx(
              "input",
              {
                inputMode: "numeric",
                onChange: (m) => {
                  const d = Math.min(ee(m.target.value), r.max);
                  a({
                    min: d,
                    max: r.max
                  });
          ...
          /* @__PURE__ */ i.jsxs("label", { className: "price-box", children: [
            ...
            /* @__PURE__ */ i.jsx(
              "input",
              {
                inputMode: "numeric",
                onChange: (m) => {
                  const d = Math.max(ee(m.target.value), r.min);
                  a({
                    min: r.min,
                    max: d
                  });
  ...
  const c = o.useRef(null), m = o.useRef(null), d = o.useRef(null), [b, x] = o.useState({
    ...
    top: 0,
    width: 0
  }), p = r.find((h) => h.id === "popular"), w = r.filter((h) => h.id !== "popular");
  return o.useEffect(() => {
    const h = () => {
      const y = d.current, v = c.current;
      if (!y || !v)
        return;
      const L = document.querySelector(".header.hotel-shell-header"), S = document.getElementById("stickySearch"), f = ((L == null ? void 0 : L.offsetHeight) ?? 72) + ((S == null ? void 0 : S.clientHeight) ?? 72) + 24, N = y.getBoundingClientRect(), P = {
        active: v.getBoundingClientRect().bottom <= f,
        left: N.left,
        top: f,
        width: N.width
      };
      x((k) => k.active === P.active && k.left === P.left && k.top === P.top && k.width === P.width ? k : P);
    };
  ...
  }), [e.currentPrice, e.id, e.imageUrl, e.location, e.title]), [a, n] = o.useState(() => window.FABState ? window.FABState.isInWishlist(t.id) : !1), s = xt[e.reviewLabel] ?? e.reviewLabel, l = e.badge.trim().length > 0;
  return o.useEffect(() => {
    if (!window.FABState)
      return;
    const r = () => {
    ...
    /* @__PURE__ */ i.jsxs("div", { className: "hotel-card-content", children: [
      ...
      /* @__PURE__ */ i.jsxs("div", { className: "hotel-location-text", children: [
        /* @__PURE__ */ i.jsx(E, { className: "hotel-location-icon", name: "map" }),
...
}, z = 50, ae = 10, U = 4, vt = "360px 0px", ie = 180, wt = ({ hotels: e }) => {
  const [t, a] = o.useState(U), [n, s] = o.useState(1), l = o.useRef(null), r = o.useRef(null), c = o.useRef(!1), m = o.useMemo(() => Math.max(1, Math.ceil(e.length / z)), [e.length]), d = o.useMemo(() => {
    const p = (n - 1) * z;
    ...
    if (!p || d.length === 0)
      return;
    const w = p.querySelector(".hotel-card-premium");
    if (!w)
      return;
    const h = window.getComputedStyle(p), y = Number.parseFloat(h.gap || "0") || 0, v = w.offsetHeight, L = p.getBoundingClientRect().top, S = window.innerHeight - L;
    if (v <= 0 || S <= 0)
      return;
    const f = Math.min(
      d.length,
      Math.max(U, Math.ceil((S + y) / (v + y)) + 1)
    );
    a((N) => f <= N ? N : f);
  }, [d.length]);
  return o.useEffect(() => {
    s(1), a(Math.min(U, e.length));
  }, [e]), o.useEffect(() => {
    ...
    const w = new IntersectionObserver(
      (h) => {
        h.forEach((y) => {
          y.isIntersecting && a((v) => Math.min(v + ae, d.length));
        });
      },
      {
        root: null,
    ...
    const p = () => {
      ...
      if (!h)
        return;
      const y = h.getBoundingClientRect().bottom, v = window.scrollY + window.innerHeight >= document.documentElement.scrollHeight - ie, L = y <= window.innerHeight + ie;
      !v && !L || a((S) => Math.min(S + ae, d.length));
    }, w = window.requestAnimationFrame(p);
    return window.addEventListener("scroll", p, { passive: !0 }), () => {
      window.cancelAnimationFrame(w), window.removeEventListener("scroll", p);
    };
  }, [d.length, t]), o.useEffect(() => {
    var p;
    if (a(Math.min(U, d.length)), !c.current) {
      c.current = !0;
      return;
    }
    ...
    /* @__PURE__ */ i.jsxs("section", { className: "hotel-main-list", ref: l, children: [
      b.map((p) => /* @__PURE__ */ i.jsx(kt, { hotel: p }, p.id)),
...
}, Ne = "jejuHotelListOfferOverridesV1", ne = (e) => typeof e != "number" || !Number.isFinite(e) || e < 0 ? null : Math.round(e), se = (e) => new Intl.NumberFormat("ko-KR", {
  currency: "KRW",
  maximumFractionDigits: 0,
  style: "currency"
}).format(e), It = () => typeof window < "u" && typeof window.localStorage < "u", jt = (e) => {
  if (!e)
    return {};
  try {
    ...
    return !t || typeof t != "object" ? {} : Object.entries(t).reduce((a, [n, s]) => {
      ...
      const r = ne(s.currentPrice);
      r !== null && (l.currentPrice = r);
      const c = ne(s.originalPrice);
      return c !== null && (l.originalPrice = c), Object.keys(l).length > 0 && (a[n] = l), a;
    }, {});
  } catch {
    return {};
  }
}, Nt = () => It() ? jt(window.localStorage.getItem(Ne)) : {}, Lt = (e, t) => {
  if (!t)
    return e;
  const a = {
    ...e
  };
  return Object.prototype.hasOwnProperty.call(t, "badge") && (a.badge = t.badge ?? ""), typeof t.originalPrice == "number" && (a.originalPrice = se(t.originalPrice)), typeof t.currentPrice == "number" && (a.currentPrice = se(t.currentPrice)), a;
}, re = (e) => {
  const t = Nt();
  return Object.keys(t).length === 0 ? e : {
    ...e,
    hotels: e.hotels.map((a) => Lt(a, t[a.id]))
  };
}, Pt = (e) => {
  if (typeof window > "u")
    return () => {
...
}, St = (e) => new URLSearchParams(e), oe = (e) => {
  if (!e)
    return "";
  const t = new Date(e);
  ...
  const t = Number.parseInt(e.replace(/[^\d]/g, ""), 10);
  return Number.isNaN(t) ? 0 : t;
}, ce = (e) => `₩${Math.max(49e3, e).toLocaleString("ko-KR")}`, Dt = (e) => e >= 9.2 ? "Exceptional" : e >= 8.5 ? "Excellent" : e >= 8 ? "Great" : "Very Good", Pe = (e) => {
  var a;
...
}, Se = (e) => e >= 9 ? ["rating-9", "rating-8", "rating-7"] : e >= 8 ? ["rating-8", "rating-7"] : ["rating-7"], Ee = (e) => {
...
}, De = (e) => e >= 9.2 ? ["ui-location-9"] : e >= 8.5 ? ["ui-location-8"] : e >= 7.8 ? ["ui-location-7"] : ["ui-location-6"], de = (e, t, a) => {
  const n = Math.max(
    7.5,
    Math.min(9.8, Number.parseFloat(e.reviewScore) + ((t == null ? void 0 : t.reviewDelta) ?? 0) + (a % 3 - 1) * 0.05)
  ), s = G(e.currentPrice) + ((t == null ? void 0 : t.currentPriceDelta) ?? 0) + a % 5 * 3e3, l = Math.max(
    s + 14e3,
    G(e.originalPrice) + ((t == null ? void 0 : t.originalPriceDelta) ?? 0) + a % 4 * 4e3
  ), r = V([
    ...e.filterIds,
    ...Le[e.locationId] ?? [],
    ...Se(n),
  ...
  const s = Number.parseFloat(e.reviewScore) || 0, l = Oe(t, a), r = l.landmarkOptions.map((m) => m.id), c = l.locationFilters[e.locationId] ?? Mt(n, e.locationId, r);
  return {
    ...e,
    filterIds: V([
      ...e.filterIds,
...
}, Ae = (e, t, a, n) => e === "hiroshima" ? n.some(
  (s) => s.title.endsWith(" 프라임") || s.title.endsWith(" 레지던스") || s.title.endsWith(" 시그니처")
) ? n : Ot(n) : n.map((s) => $t(s, e, t, a)), Ft = (e, t) => e.filter((a) => a.filterIds.includes(t)).length, _t = (e, t, a, n) => {
  const s = Oe(e, t);
  return [
    {
      id: "star-rating",
...
}, V = (e) => Array.from(new Set(e.filter((t) => t.trim() !== ""))), M = (e, t, a) => ({
  label: t,
  countryLabel: a,
  ...
  return n.includes("제주") || n.includes("jeju") ? { region: "jeju", profile: _.jeju } : n.includes("오사카") || n.includes("osaka") ? { region: "osaka", profile: _.osaka } : n.includes("방콕") || n.includes("bangkok") ? { region: "bangkok", profile: M("bangkok", "방콕", "태국") } : n.includes("도쿄") || n.includes("tokyo") ? { region: "tokyo", profile: M("tokyo", "도쿄", "일본") } : n.includes("다낭") || n.includes("danang") ? { region: "danang", profile: M("danang", "다낭", "베트남") } : n.includes("싱가포르") || n.includes("singapore") ? { region: "singapore", profile: M("singapore", "싱가포르", "싱가포르") } : { region: le, profile: _[le] };
}, Re = (e, t, a, n, s = []) => [
  {
    id: "popular",
    title: `${t} 인기 검색 조건`,
    options: $(a.popularFilters, s)
  },
  {
    id: "property-types",
    title: "숙소 종류",
    options: $(a.propertyTypes, s)
  },
  {
    id: "locations",
    title: "지역",
    options: $(a.locations, s)
  },
  {
    id: "payment-options",
    title: "결제 관련 옵션",
    options: $(a.paymentOptions, s)
  },
  {
    id: "guest-ratings",
    title: "투숙객 평가 점수",
    options: $(a.guestRatings, s)
  },
  {
    id: "amenities",
    title: "숙소 편의 시설 및 서비스",
    options: $(a.amenities, s)
  },
  ..._t(e, t, a, n).map((l) => ({
    ...l,
    options: $(l.options, s)
  ...
  const a = Me(e.region, e.regionLabel).profile, n = $e(e), s = Ae(e.region, e.regionLabel, a, e.hotels);
  return {
    ...e,
    filterSections: Re(e.region, e.regionLabel, a, s, n),
    hotels: s
  };
}, Ht = (e) => {
  var x, p, w, h, y, v;
  const t = St(e), a = t.get("keyword"), n = t.get("region"), s = ye(e), l = Me(n, a), r = ((x = s.destinationValue) == null ? void 0 : x.trim()) || `${l.profile.label}, ${l.profile.countryLabel}`, c = oe(((p = s.calendar) == null ? void 0 : p.checkIn) ?? null), m = oe(((w = s.calendar) == null ? void 0 : w.checkOut) ?? null), d = c && m ? `${c} - ${m}` : "날짜를 선택하세요", b = Ae(l.region, l.profile.label, l.profile, l.profile.hotels);
  return {
    ...
    filterSections: Re(l.region, l.profile.label, l.profile, b),
    hotels: b
  };
}, Ut = () => {
  var t;
  ...
  return (Tt[t] ?? [t]).includes(e.propertyTypeId) ? !0 : t === "hotel" ? a.includes("호텔") || a.includes("hotel") : t === "resort" ? a.includes("리조트") || a.includes("resort") : t === "ryokan" ? a.includes("료칸") || a.includes("ryokan") : t === "apartment" ? a.includes("아파트") || a.includes("apartment") : t === "capsule" ? a.includes("캡슐") : t === "poolvilla" ? a.includes("풀빌라") : t === "private-house-entire" ? a.includes("프라이빗") || a.includes("독채") : t === "villa" || t === "resort-villa" ? a.includes("빌라") : !1;
}, me = (e, t) => e.filter((a) => {
  const n = G(a.currentPrice);
  if (t.minPrice !== null && n < t.minPrice || t.maxPrice !== null && n > t.maxPrice || t.guestRatingThreshold !== null && Bt(a.reviewScore) < t.guestRatingThreshold || t.locationIds.length > 0 && !t.locationIds.includes(a.locationId))
    return !1;
  ...
  return a.delete("filter"), V(t).forEach((n) => {
    a.append("filter", n);
  }), a;
}, he = (e) => new Set(e), ge = (e) => {
  if (e.length === 0)
  ...
  const t = e.map((n) => G(n.currentPrice));
  return {
    min: 0,
    max: Math.max(...t)
  };
...
}, Wt = "property-types", qt = "guest-ratings", zt = "locations", ea = () => {
  const e = o.useMemo(() => {
    const f = Ut();
    return f ? ue(f) : null;
  }, []), t = o.useMemo(() => e ?? Ht(window.location.search), [e]), [a, n] = o.useState(() => t), [s, l] = o.useState(0), r = o.useMemo(() => re(a), [a, s]), [c, m] = o.useState(
    () => he(pe(t))
  ), [d, b] = o.useState(
    () => ge(re(t).hotels)
  );
  ...
  const p = (f) => {
    m((N) => {
      const I = new Set(N);
      I.has(f) ? I.delete(f) : I.add(f);
      const P = Array.from(I), k = Vt(window.location.search, P), T = `${window.location.pathname}?${k.toString()}`;
      if (window.history.replaceState(null, "", T), x) {
        const C = `/api/stay/hotel-list?${k.toString()}`;
        fetch(C, {
          headers: {
    ...
    var k, T, C;
    const f = ((k = r.filterSections.find((g) => g.id === Wt)) == null ? void 0 : k.options.map((g) => g.id).filter((g) => c.has(g))) ?? [], N = ((T = r.filterSections.find((g) => g.id === qt)) == null ? void 0 : T.options) ?? [], I = ((C = r.filterSections.find((g) => g.id === zt)) == null ? void 0 : C.options.map((g) => g.id).filter((g) => c.has(g))) ?? [], P = N.filter((g) => c.has(g.id)).map((g) => Number.parseInt(g.id.replace("rating-", ""), 10)).filter((g) => !Number.isNaN(g));
    return {
      propertyTypeIds: f,
      locationIds: I,
      guestRatingThreshold: P.length > 0 ? Math.max(...P) : null,
      minPrice: null,
      maxPrice: null,
      selectedOptionIds: Array.from(c)
    };
  }, [c, r.filterSections]), h = o.useMemo(() => me(r.hotels, w), [w, r.hotels]), y = o.useMemo(() => ge(h), [h]);
  o.useEffect(() => {
    b((f) => be(f, y));
  }, [y]);
  const v = (f) => {
    ...
    minPrice: d.min,
    maxPrice: d.max
  }), [w, d.max, d.min]), S = o.useMemo(() => me(h, L), [L, h]);
  return /* @__PURE__ */ i.jsxs(i.Fragment, { children: [
    /* @__PURE__ */ i.jsx(
      yt,
      {
