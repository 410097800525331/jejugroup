    ...
    <a href="../../jejustay/pages/hotel/jejuhotel.html" class="portal-btn" title="제주스테이로">
        ...
        <main class="admin-main">
            <div class="admin-page-header">
                <h1 class="admin-page-title">예약/결제 관리</h1>
                <div style="display: flex; gap: var(--admin-space-md); align-items: center;">
                    ...
                    <div class="admin-segment-control" id="admin-domain-filters">
                        <button class="segment-btn active" data-domain="all">전체 내역</button>
            ...
            <div class="admin-table-actions"
                ...
                <div style="display:flex; gap:8px;">
                    ...
                    <button class="admin-btn admin-btn-primary">신규 예약 수기 등록</button>
                </div>
            </div>
            ...
            <div style="display:flex; justify-content:center; margin-top:20px; gap:8px;">
                ...
                <button class="admin-btn admin-btn-outline">3</button>
