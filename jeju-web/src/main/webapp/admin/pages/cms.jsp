...
<head>
    ...
    <title>콘텐츠 관리 (CMS) - 제주여행 관리자</title>
...
<body class="admin-mode">
    ...
    <div class="admin-layout">
        <aside class="admin-sidebar" id="admin-sidebar">
            ...
            <nav class="admin-menu" id="admin-sidebar-menu"></nav>
        </aside>
    ...
    <a href="../../jejustay/pages/hotel/jejuhotel.html" class="portal-btn" title="제주스테이로">
        ...
        <main class="admin-main">
            <div class="admin-page-header">
                <h1 class="admin-page-title">콘텐츠 관리 (CMS)</h1>
                <div style="display: flex; gap: var(--admin-space-md); align-items: center;">
                    <div class="admin-segment-control" id="admin-domain-filters">
                        <button class="segment-btn active" data-domain="all">전체 노출</button>
                        <button class="segment-btn" data-domain="flight">항공편 배너</button>
                        <button class="segment-btn" data-domain="hotel">숙박 공지</button>
                        <button class="segment-btn" data-domain="rentcar">렌터카 이벤트</button>
                    </div>
                </div>
            </div>
            ...
            <div class="admin-table-actions"
                ...
                <div style="display:flex; gap:8px;">
                    <input type="text" placeholder="콘텐츠 제목 또는 태그 검색..."
                    ...
                    <select
                        ...
                        <option value="hero">상단 슬라이드 배너</option>
                        <option value="notice">공지사항</option>
                    </select>
                </div>
                <div style="display:flex; gap:8px;">
                    <button class="admin-btn admin-btn-outline">게시글 일괄 내리기</button>
                    <button class="admin-btn admin-btn-primary">신규 콘텐츠 제작</button>
                </div>
            </div>
