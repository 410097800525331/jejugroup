...
<body class="jejuair-main-content">
  ...
  <script>
    ...
    document.querySelector(".search_form").addEventListener("submit", (e) => {
      ...
      const reserveNo = document.querySelector('input[placeholder="예약번호 입력"]').value;
      const date = document.getElementById("flight_date").value;

      if (!reserveNo || !date) {
        alert("예약번호와 탑승일자를 입력해 주세요.");
        return;
      }
