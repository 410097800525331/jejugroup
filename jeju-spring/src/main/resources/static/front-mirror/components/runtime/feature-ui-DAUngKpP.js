...
import { u as T, T as W, i as F, A as L, v as R, j as z, w as I } from "./icon-vendor-Dpra3II6.js";
const G = () => /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
  ...
  /* @__PURE__ */ e.jsxs("div", { className: "res-drawer-panel", id: "resDrawerPanel", children: [
    /* @__PURE__ */ e.jsx("button", { className: "res-drawer-close", id: "resDrawerClose", "aria-label": "닫기", children: /* @__PURE__ */ e.jsx("svg", { width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: /* @__PURE__ */ e.jsx("path", { d: "M18 6L6 18M6 6l12 12" }) }) }),
    /* @__PURE__ */ e.jsxs("div", { className: "res-drawer-visual", children: [
      /* @__PURE__ */ e.jsxs("h2", { className: "res-drawer-title", "data-lang": "resCheckTitle", children: [
        "비회원 ",
  ...
  const l = s.querySelectorAll(".wishlist-btn__burst");
  r && l.length > 0 && l.forEach((d, c) => {
...
}, K = ({ active: s, ariaLabel: r, className: n = "", onToggle: l }) => {
  ...
  ({ id: s, className: r, label: n, icon: l, badgeCount: a, onClick: d, onMouseEnter: c, onMouseLeave: u }, f) => /* @__PURE__ */ e.jsxs(
    "div",
    {
      id: s,
      ref: f,
      ...
      onMouseLeave: u,
      children: [
        /* @__PURE__ */ e.jsx(l, { className: "card-icon" }),
...
function P({ isOpen: s, wishlist: r, onClose: n, onRemove: l }) {
...
const E = (s) => String(s);
function J() {
  const s = i.useRef(null), [r, n] = i.useState(!1), [l, a] = i.useState(() => {
    try {
      return JSON.parse(localStorage.getItem("jeju_wishlist") || "[]");
    } catch {
      return [];
    }
  }), [d, c] = i.useState(() => localStorage.getItem("jeju_fab_currency") || "KRW"), [u, f] = i.useState(!1), [g, m] = i.useState(!1);
  i.useEffect(() => {
  ...
  const { contextSafe: j } = M({ scope: s }), w = j(() => {
    ...
    c(o), localStorage.setItem("jeju_fab_currency", o), document.dispatchEvent(new CustomEvent("fabCurrencyChanged", { detail: o }));
  }, C = () => {
    var o;
    (o = window.hotelChatbot) == null || o.openChatbot(), r && w();
  }, k = (o) => {
    const x = E(o), t = l.filter((p) => E(p.id) !== x);
...
여행의 모든 고민을 무엇이든 말씀해 주세요. 😊`, $ = (s) => {
  var a, d, c, u, f, g;
  const r = (c = (d = (a = s.choices) == null ? void 0 : a[0]) == null ? void 0 : d.message) == null ? void 0 : c.content;
...
`).trim() || null;
}, U = ({ isOpen: s, onClose: r, language: n, onLanguageChange: l }) => {
  const [a, d] = i.useState([]), [c, u] = i.useState(""), [f, g] = i.useState(!1), [m, j] = i.useState("checking"), w = i.useRef(null), h = i.useCallback(async () => {
    try {
  ...
  i.useEffect(() => {
    ...
    const t = (p) => {
      const b = p;
      (b.detail === "ko" || b.detail === "en") && l(b.detail);
    };
  ...
  const y = i.useCallback((t, p) => {
    ...
    if (!(!t || f)) {
      ...
      try {
        ...
        const b = await p.json(), _ = $(b) ?? "응답 처리 실패";
        y("bot", String(_));
      } catch (p) {
  ...
  return /* @__PURE__ */ e.jsxs("div", { className: `chatbot-container ${s ? "active" : ""}`, children: [
    ...
    /* @__PURE__ */ e.jsx("form", { className: "chatbot-input-area", onSubmit: o, children: /* @__PURE__ */ e.jsxs("div", { className: "chatbot-input-wrapper", children: [
      ...
      /* @__PURE__ */ e.jsx("button", { className: "chatbot-send-btn", type: "submit", disabled: f || !c.trim(), children: /* @__PURE__ */ e.jsxs("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [
