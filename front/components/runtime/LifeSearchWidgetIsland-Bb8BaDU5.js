import { r as s, j as t, H as E } from "./index-CoeQRDgQ.js";
import { g as F, a as q, s as B, c as Y, S as K, d as Q, b as X, D as J } from "./SearchGuestPopup-i_f_WXLe.js";
const z = [
...
], ee = "jeju:life-search-submit", D = 14, I = 24 * 60 * 60 * 1e3, ae = {
  destinationValue: "",
  isDestinationOpen: !1,
  isGuestOpen: !1,
  isOptionsOpen: !1,
    ...
    case "SHIFT_CALENDAR_MONTH":
      return {
        ...
        calendar: {
          ...e.calendar,
          hoverDate: null,
          visibleMonth: B(e.calendar.visibleMonth, a.delta)
        }
      };
  ...
  const c = s.useCallback((l) => {
  ...
  }, []), g = s.useCallback((l, o, v) => {
    v.stopPropagation(), n({ type: "ADJUST_GUEST", key: l, delta: o });
  }, []), C = s.useCallback((l) => {
    ...
    if ((o - l) / I < D) {
      window.alert(`장기 체류 서비스는 최소 ${D}박부터 예약 가능합니다`);
      return;
    }
  ...
  }, [a.guest.adults, a.guest.children, a.guest.rooms]), p = s.useMemo(() => $.filter((l) => a.requiredOptions.includes(l.value)).map((l) => l.label), [a.requiredOptions]), R = s.useMemo(() => p.length === 0 ? "선택사항 없음" : p.length > 2 ? `${p[0]}, ${p[1]} 외 ${p.length - 2}` : p.join(", "), [p]), G = s.useMemo(() => {
  ...
  return /* @__PURE__ */ t.jsx(U.Provider, { value: W, children: e });
}, b = () => {
  ...
  return /* @__PURE__ */ t.jsx("div", { className: "search-widget-large long-stay-search-widget", children: /* @__PURE__ */ t.jsx("div", { className: "search-widget-v2", children: /* @__PURE__ */ t.jsxs("div", { className: "global-search-bar-v2", id: "mnSearchForm", children: [
    /* @__PURE__ */ t.jsxs("div", { className: `search-item-v2${e.isDestinationOpen ? " active" : ""}`, id: "destinationFieldLarge", onClick: m, children: [
      /* @__PURE__ */ t.jsx("div", { className: "item-icon-v2", children: /* @__PURE__ */ t.jsx(E, { className: "life-search-icon", name: "map-pin" }) }),
    ...
    /* @__PURE__ */ t.jsxs("div", { className: `search-item-v2${e.calendar.isOpen ? " active" : ""}`, id: "checkInField", onClick: k, children: [
      /* @__PURE__ */ t.jsx("div", { className: "item-icon-v2", children: /* @__PURE__ */ t.jsx(E, { className: "life-search-icon", name: "calendar" }) }),
      /* @__PURE__ */ t.jsxs("div", { className: "item-content-v2", children: [
    ...
    /* @__PURE__ */ t.jsxs("div", { className: `search-item-v2${e.isGuestOpen ? " active" : ""}`, id: "guestFieldLarge", onClick: u, children: [
      /* @__PURE__ */ t.jsx("div", { className: "item-icon-v2", children: /* @__PURE__ */ t.jsx(E, { className: "life-search-icon", name: "users" }) }),
      /* @__PURE__ */ t.jsxs("div", { className: "item-content-v2", children: [
    ...
    /* @__PURE__ */ t.jsxs("div", { className: `search-item-v2${e.isOptionsOpen ? " active" : ""}`, id: "optionsFieldLarge", onClick: L, children: [
      /* @__PURE__ */ t.jsx("div", { className: "item-icon-v2", children: /* @__PURE__ */ t.jsx(E, { className: "life-search-icon", name: "sliders-horizontal" }) }),
      /* @__PURE__ */ t.jsxs("div", { className: "item-content-v2", children: [
    ...
    /* @__PURE__ */ t.jsx("div", { className: "search-btn-wrapper-v2", children: /* @__PURE__ */ t.jsxs("button", { className: "search-btn-v2", id: "searchBtn", onClick: N, title: d, type: "button", children: [
      /* @__PURE__ */ t.jsx(E, { className: "life-search-button-icon", name: "search" }),
      /* @__PURE__ */ t.jsx("span", { "data-lang": "btnSearch", children: "검색하기" })
    ] }) })
  ] }) }) });
}, ue = () => /* @__PURE__ */ t.jsx(te, { children: /* @__PURE__ */ t.jsx(de, {}) }), Oe = () => /* @__PURE__ */ t.jsx(ue, {});
export {
  Oe as LifeSearchWidgetIsland
};
