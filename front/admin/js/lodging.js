...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const lodgingDataModule = await import('../data/lodging-config.js');
    const TAB_CONFIG = Object.freeze(lodgingDataModule.default ?? lodgingDataModule.LODGING_TAB_CONFIG ?? lodgingDataModule.tabConfig ?? {});
    const DEFAULT_TAB = lodgingDataModule.DEFAULT_TAB ?? lodgingDataModule.defaultTab ?? 'stay';
