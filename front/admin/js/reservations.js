...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const reservationsDataModule = await import('../data/reservations-config.js');
    const TAB_CONFIG = Object.freeze(reservationsDataModule.default ?? reservationsDataModule.RESERVATIONS_TAB_CONFIG ?? reservationsDataModule.tabConfig ?? {});
    const DEFAULT_TAB = reservationsDataModule.DEFAULT_TAB ?? reservationsDataModule.defaultTab ?? 'booking';
