...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const cmsDataModule = await import('../data/cms-config.js');
    const TAB_CONFIG = Object.freeze(cmsDataModule.default ?? cmsDataModule.CMS_TAB_CONFIG ?? cmsDataModule.tabConfig ?? {});
    const DEFAULT_TAB = cmsDataModule.DEFAULT_TAB ?? cmsDataModule.defaultTab ?? 'notices';
