---
name: ouroboros-run
description: Enter implementation from a frozen seed using the repository's existing Route A/B/C system. Use when the user invokes `ooo run` or asks to build from the spec, start implementation from `docs/seeds/SEED.yaml`, or execute the agreed contract without introducing separate polling or orchestration layers.
---
