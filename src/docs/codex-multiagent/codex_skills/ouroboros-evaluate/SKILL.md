...
4. Run evaluation in stages:
   ...
   - Stage 3: reviewer integration when Route B or Route C requires it
...
If the active route is Route B or Route C:
...
- Do not bypass Route B/C reviewer requirements.
