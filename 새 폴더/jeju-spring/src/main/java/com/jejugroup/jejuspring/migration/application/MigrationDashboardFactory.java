...
public class MigrationDashboardFactory {
    ...
    private List<MigrationRouteView> buildRoutes() {
        return List.of(
            ...
            new MigrationRouteView("Auth login", "/auth/login", "First manually migrated Thymeleaf service page"),
            new MigrationRouteView("Legacy-compatible login", "/pages/auth/login.html", "Legacy route mapped to Spring login view"),
            new MigrationRouteView("Auth signup", "/auth/signup", "Second manually migrated Thymeleaf service page"),
            new MigrationRouteView("Legacy-compatible signup", "/pages/auth/signup.html", "Legacy route mapped to Spring signup view"),
            new MigrationRouteView("Auth pass", "/auth/pass", "Third manually migrated Thymeleaf service page"),
            new MigrationRouteView("Legacy-compatible pass", "/pages/auth/pass_auth.html", "Legacy route mapped to Spring PASS auth view"),
