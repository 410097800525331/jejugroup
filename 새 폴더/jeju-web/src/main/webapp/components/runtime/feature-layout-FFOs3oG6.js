...
import { U as x, a as N, S as v, b as E, c as b, P as f, d as p, e as S, M as I, f as R, g as w, L as A, h as C, H as k, i as T, j as L, k as y, G as M, C as V, l as H, m as _, n as O, o as P, p as U, q as $, B as g, r as G, s as D, t as q } from "./icon-vendor-Dpra3II6.js";
import { a as B } from "./legacy-core-C4kaoWaO.js";
const Y = {
  "book-open": G,
  "building-2": g,
  calendar: $,
...
] }), z = (s) => s * Math.PI / 180, K = (s, a, l, r, n) => {
  const h = a > 1 ? (n - r) / (a - 1) : 0, d = r + h * s, o = z(d), c = Math.cos(o) * l, t = Math.sin(o) * l;
  return {
    "--tx": `${c.toFixed(2)}px`,
    "--ty": `${t.toFixed(2)}px`,
    ...
    /* @__PURE__ */ e.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ e.jsx("div", { className: "family-radial-items", children: s.map((t, m) => {
            const j = t.icon;
